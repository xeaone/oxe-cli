...
Global.oHeadPlaceholderEnd = `<!--/o-head-placeholder-->`;
Global.oHeadPlaceholderStart = `<!--o-head-placeholder-->`;
Global.oHeadPlaceholder = `${Global.oHeadPlaceholderStart}${Global.oHeadPlaceholderEnd}`;
